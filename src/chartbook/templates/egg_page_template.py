...
<link rel="stylesheet" href="assets/split-dashboard.css?v=20260321h">
...
<div class="shell">
  ...
  <section class="section" id="layer-flock">
    ...
    <div class="grid">
      <article class="card"><h3>Table-Egg Layer Flock Size Comparison</h3><div class="sub">Historical comparison of table-egg layers on hand</div><canvas id="tableLayersChart" height="120"></canvas></article>
  ...
  <section class="section" id="production-figures">
    ...
    <div class="grid">
      ...
      <article class="card"><h3>Historical Table Egg Production</h3><div class="sub">Trailing 3-month table egg production</div><canvas id="trailingProdChart" height="120"></canvas></article>
  ...
  <section class="section" id="prices">
    ...
    <div class="grid">
      ...
      <article class="card"><h3>Retail Egg Price</h3><div class="sub">Grade A Large eggs, U.S. city average</div><canvas id="eggPriceCompareChart" height="120"></canvas></article>
      <article class="card"><h3>Retail Prices vs Farmgate Price Received Spread Estimate</h3><div class="sub">Grade A Large eggs, U.S. city average minus USDA NASS all-eggs price received (prior month average)</div><canvas id="eggPriceSpreadChart" height="120"></canvas></article>
      <article class="card" id="retailFeatureWrap"><h3>Egg Retail Feature Rates</h3><div class="sub">% of retailers discounting eggs</div><canvas id="retailFeatureChart" height="120"></canvas></article>
    </div>
  </section>
  ...
  <section class="section" id="breeder-flock">
    ...
    <div class="grid">
      ...
      <article class="card"><h3>Breeder Flock Size and Change</h3><div class="sub">Egg-type breeder flock size (first of month)</div><canvas id="breederFlockChart" height="120"></canvas></article>
    </div>
  </section>
  ...
  <section class="section" id="inputs">
    ...
    <div class="grid">
      ...
      <article class="card" id="dieselWrap"><h3>Input Cost Price Changes</h3><div class="sub">% change in price of common egg input costs</div><canvas id="dieselChart" height="120"></canvas></article>
    </div>
  </section>
...
<script src="assets/dashboard-common.js?v=20260321h"></script>
<script src="assets/egg-dashboard.js?v=20260321h"></script>
</body>
</html>
"""
