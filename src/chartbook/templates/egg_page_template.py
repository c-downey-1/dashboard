...
<title>Egg Industry Executive Chartbook</title>
<link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
<link href="https://fonts.googleapis.com/css2?family=Lexend:wght@300;400;500;600;700&display=swap" rel="stylesheet">
<link rel="stylesheet" href="assets/split-dashboard.css?v=20260721b">
<script src="https://cdn.jsdelivr.net/npm/chart.js@4"></script>
<script type="text/javascript">(function(c,l,a,r,i,t,y){c[a]=c[a]||function(){(c[a].q=c[a].q||[]).push(arguments)};t=l.createElement(r);t.async=1;t.src="https://www.clarity.ms/tag/"+i;y=l.getElementsByTagName(r)[0];y.parentNode.insertBefore(t,y);})(window,document,"clarity","script","vzbyd9vlgw");</script>
</head>
<body>
<div class="shell">
  <header class="iaa-bar">
    ...
    <strong class="iaa-header-title">Egg Industry Executive Chartbook</strong>
  </header>

  <nav class="mobile-section-nav" id="mobileSectionNav" aria-label="Jump to section">
    <select class="mobile-section-select" id="mobileSectionSelect">
  ...
  <div class="dashboard-layout">
    ...
    <a class="sidebar-brand" id="sidebarBrand" href="https://innovateanimalag.org/" target="_blank" rel="noreferrer">
  ...
  <section class="section" id="layer-flock">
    ...
    <div class="grid">
      ...
      <article class="card"><h3>Table-Egg Layer Flock Size</h3><div class="sub">Monthly table-egg layers on hand (first of month), with the IAA Model Prediction anchored at Dec 2022</div><canvas id="tableLayersTrendChart"></canvas></article>
      <article class="card" id="compositionWrap"><h3>Flock Cage-Free Composition</h3><div class="sub">Table layer flock by system type and cage-free share</div><canvas id="compositionChart"></canvas></article>
      <article class="card"><h3>Flock Turnover</h3><div class="sub">Hens sold for slaughter, destroyed, composted, etc</div><canvas id="turnoverChart"></canvas></article>
      <article class="card wide"><h3>Flock Turnover Rate</h3><div class="sub">Monthly flock turnover as a share of the table-egg layer flock</div><canvas id="turnoverRateChart"></canvas></article>
      <article class="card"><h3>Molting Data</h3><div class="sub">Share of flock molted or being molted</div><canvas id="moltChart"></canvas></article>
    </div>
  </section>
  ...
  <section class="section" id="production-figures">
    ...
    <div class="grid">
      ...
      <article class="card" id="eggInventoryYoYWrap"><h3>Inventory vs. Prior Year</h3><div class="sub">Trailing 4-week-average national shell egg inventory, % change vs. the same weeks a year earlier</div><canvas id="eggInventoryYoYChart"></canvas></article>
    </div>
  </section>
  ...
  <section class="section" id="breeder-flock">
    ...
    <div class="grid">
      ...
      <article class="card"><h3>Pullet Inventory</h3><div class="sub">Replacement Egg-Type Pullets on Hand (1st of Month)</div><canvas id="pulletClimbChart"></canvas></article>
      <article class="card wide"><h3>Flock Pipeline Intensity</h3><div class="sub">Pullets per 100 table layers</div><canvas id="pipelineChart"></canvas></article>
      <article class="card"><h3>Breeder Flock Size and Change</h3><div class="sub">Egg-type breeder flock size (first of month)</div><canvas id="breederFlockChart"></canvas></article>
    </div>
  </section>
  ...
  <section class="section" id="international">
    <div class="section-head"><div><h2>International</h2><p>Egg trade flows and global in-ovo sexing adoption.</p></div></div>
    <div class="grid">
      ...
      <article class="card" id="euPenetrationWrap">
        <h3>EU In-Ovo Sexing Market Penetration</h3>
        <div class="sub" id="euPenetrationSub">Share of EU commercial layer hens sexed in-ovo, as of June 1, 2026</div>
        <div class="eu-toggle-bar">
          <label class="eu-penetration-toggle" for="euPenetrationToggle">
            <span>Include Backyard Flocks</span>
            <input type="checkbox" id="euPenetrationToggle">
            <i aria-hidden="true"></i>
          </label>
        </div>
        <canvas id="euPenetrationChart" role="img" aria-label="Line chart of EU in-ovo sexing market penetration with uncertainty ranges and labeled estimates for 2024 through 2026."></canvas>
      </article>
    </div>
  </section>
    ...
    <div class="grid">
      <article class="card">
        <form class="dashboard-signup-form" id="eggDashboardSignupForm">
          <div class="dashboard-signup-row">
            ...
            <label class="dashboard-signup-field" for="dashboardSignupLastName">
              <span>Last Name</span>
              <input id="dashboardSignupLastName" name="lastName" type="text" autocomplete="family-name" placeholder="Last name">
            </label>
          </div>
          ...
          <div class="dashboard-signup-checkboxes">
            <span class="dashboard-signup-checkboxes-label">I'm interested in:</span>
            <label class="dashboard-signup-checkbox">
              <input type="checkbox" name="eggUpdates" checked>
              <span>Egg Executive Monthly Updates</span>
            </label>
            <label class="dashboard-signup-checkbox">
...
<script src="assets/dashboard-common.js?v=20260721b"></script>
<script src="assets/egg-dashboard.js?v=20260721b"></script>
</body>
</html>
"""
