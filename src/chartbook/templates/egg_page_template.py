...
<link rel="stylesheet" href="assets/split-dashboard.css?v=20260320cc">
...
<div class="shell">
  ...
  <section class="section" id="inputs">
    ...
    <div class="grid">
      ...
      <article class="card" id="dieselWrap"><h3>Input Cost Indices</h3><div class="sub">Weekly feed and diesel with monthly packaging; Jan 2025 = 100</div><canvas id="dieselChart" height="120"></canvas></article>
    </div>
  </section>
...
<script src="assets/dashboard-common.js?v=20260320cc"></script>
<script src="assets/egg-dashboard.js?v=20260320cc"></script>
</body>
</html>
"""
